...
void lv_app_scroll(void)
{
    ...
    case 0:
        ...
        menu_item_create(cont, &label_style, event_handler, &alert, "#000000 灯光控制#", lv_app_load_light_scr);
        menu_item_create(cont, &label_style, event_handler, &fftMusic, "#000000 律动音乐#", lv_app_load_fft_scr);
        menu_item_create(cont, &label_style, event_handler, &home, "#000000 首页#", lv_app_load_home_scr);
        menu_item_create(cont, &label_style, event_handler, &camera, "#000000 相机#", lv_app_load_camera_scr);
        break;
    case 1:
        menu_item_create(cont, &label_style, event_handler, &cloud, "#000000 天气#", lv_app_load_weather_scr);
        menu_item_create(cont, &label_style, event_handler, &alert, "#000000 灯光控制#", lv_app_load_light_scr);
    ...
    // lv_obj_scroll_to_view(lv_obj_get_child(cont, page_idx), LV_ANIM_OFF);
